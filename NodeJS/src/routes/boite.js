...
const { search, searchAllBoites, ficheBoite, nouveaute, deleteCollec, addCollec, addWishlist, deleteWishlist, searchBestBoites } = require("../controllers/boite");
...
// 9 //
router.post("/searchBestBoite", searchBestBoites);
