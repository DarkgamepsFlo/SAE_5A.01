<template>
    <div id="search-page">
        ...
        <div id="tab-container">
            ...
            <ProfilBoite v-for="boite in items" :key="boite.nom_boi" :boite="boite" :search="true" :collection_uti="collection_uti" :collection_id="collection_id" @updateCollec="updateCollec"/>
        </div>
    </div>
